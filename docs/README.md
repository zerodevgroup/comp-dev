...
## API Setup
[comp-dev-api](https://github.com/zerodevgroup/comp-devgc/blob/master/docs/COMP-DEV-API.md)

## Data Import
[comp-dev-data](https://github.com/zerodevgroup/comp-devgc/blob/master/docs/COMP-DEV-DATA.md)

## Web Setup
[comp-dev-web](https://github.com/zerodevgroup/comp-devgc/blob/master/docs/COMP-DEV-WEB.md)
